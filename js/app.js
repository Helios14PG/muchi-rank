...
function showRules() {
  showInfoModal("Muchi Rankとは", `
    <p>10人のサッカー選手をOVRが高い順だと思うランキングへ配置します。</p>
    <p>採点は45組の順位関係、最大連続正解、1位、最下位の一致で決まります。満点は150点です。</p>
    <p>OVRオープン、チームオープン、ハイアンドロー、選手交代は各1回だけ使用できます。</p>
    <p>10人配置後はアディショナルタイムに入り、一度だけ2名の順位を入れ替えられます。</p>
  `);
}
